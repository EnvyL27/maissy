...
import { forkJoin } from 'rxjs';
  ...
  @Component({
    selector: 'app-cost-oci2',
    templateUrl: './cost-oci2.component.html',
    styleUrls: ['./cost-oci2.component.css']
  })

  export class CostOci2Component implements OnInit {
    ...
    async ngOnInit(): Promise<void> {
      ...
      this.loaddata = new Promise(resolve => {
        ...
        forkJoin(this.service.getCostOci2(),
          this.service.getCostOci2Past()).subscribe(([data, data2]) => {
            // //console.log(data);
            // //console.log(data2);
            this.cost = data;
            this.cost2 = data2;
